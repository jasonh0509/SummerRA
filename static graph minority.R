...
graphtotal<-subset(totaldata,select = c(Place,Year,Geoid,Rate.Denom,Value.Count,Value.Rate))
...
mapping2010<-mapping2010%>%
  mutate(RateCal=(mapping2010$Value.Rate)/(mapping2010$Rate.Denom))
...
grid.arrange(plot2010,plot2015,plot2020,nrow=3)
